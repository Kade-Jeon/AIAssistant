...
/**
 * 유저–프로젝트 소유 매핑. 어떤 유저가 어떤 projectId를 사용하는지, 제목(subject)과 함께 저장.
...
public class UserProjectEntity {
    ...
    public UserProjectEntity(String userId, String projectId, String subject) {
        this.id = new UserProjectId(userId, projectId);
